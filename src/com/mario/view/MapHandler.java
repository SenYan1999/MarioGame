...
public class MapHandler {
    ...
    public String selectMap(Point mouseLocation){
        for(MapItem item : mapItems){
            ...
            boolean withinX = location.x <= mouseLocation.x && location.x + dimension.width >= mouseLocation.x;
            boolean withinY = location.y <= mouseLocation.y && location.y + dimension.width >= mouseLocation.y;
    ...
    public String selectMap(int idx){
